...
# For some reason, the following command stopped working. I do not spot any visible errors.
...
# I have been prompted in week 6 assignment to compare selected values with my new predicted values. I must point out that some of the 
# values indicated in the prompt are impossible to compare as these refer to the ungrouped dataset and not the aggregated one.
# Therefore I decided to create a new data frame, with the observed and predicted values side to side to offer a quick comparison.